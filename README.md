       ...
       <tr class="border-b border-[#30363d]">
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#f06529] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="HTML5 icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/html-5--v1.png" width="12"/>
          HTML5
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#3c873a] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Node.js icon" class="inline-block" height="12" src="https://img.icons8.com/fluency/48/node-js.png" width="12"/>
          NODE.JS
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#4479a1] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="MySQL icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/mysql-logo.png" width="12"/>
          MYSQL
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#0db7ed] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Docker icon" class="inline-block" height="12" src="https://img.icons8.com/fluency/48/docker.png" width="12"/>
          DOCKER
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
       ...
       <tr class="border-b border-[#30363d]">
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#264de4] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="CSS3 icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/css3.png" width="12"/>
          CSS3
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#357a38] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Python icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/python.png" width="12"/>
          PYTHON
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#336791] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="PostgreSQL icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/postgreesql.png" width="12"/>
          POSTGRESQL
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#6e6e6e] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Kafka icon" class="inline-block" height="12" src="https://img.icons8.com/nolan/50/apache-kafka.png" width="12"/>
          KAFKA
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
       ...
       <tr class="border-b border-[#30363d]">
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#f7df1e] text-black text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="JavaScript icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/javascript.png" width="12"/>
          JAVASCRIPT
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#f0db4f] text-black text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Java icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/java-coffee-cup-logo--v1.png" width="12"/>
          JAVA
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#4db33d] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="MongoDB icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/mongo-db.png" width="12"/>
          MONGODB
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
       ...
       <tr class="border-b border-[#30363d]">
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#61dafb] text-black text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="React icon" class="inline-block" height="12" src="https://img.icons8.com/office/40/react.png" width="12"/>
          REACT
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
       ...
       <tr class="border-b border-[#30363d]">
        <td class="border-r border-[#30363d] py-1 px-2">
         <span class="inline-flex items-center gap-1 bg-[#02569b] text-white text-[9px] font-semibold rounded px-1.5 py-[1px]">
          <img alt="Flutter icon" class="inline-block" height="12" src="https://img.icons8.com/color/48/flutter.png" width="12"/>
          FLUTTER
         </span>
        </td>
        <td class="border-r border-[#30363d] py-1 px-2">
